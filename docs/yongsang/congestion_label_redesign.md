...
L3 recall(%), 5시드 평균 — 채택된 k=2/m=2만 표시:

```
nogate    ████████████████████████████             70.4 ±2.0
k=2/m=2   ███████████████████████████████████ ★    87.1 ±2.3   ← 채택
k=3/m=2   ███████████████████████████████          78.1 ±2.8   (원안, §4 위)
k=3/m=3   █████████████████████████████████        82.7 ±2.2
k=5/m=2   ███████████████████████████████          78.6 ±3.4
k=5/m=3   ██████████████████████████                65.6 ±3.1
```
...
```
Lane A ─ 배포 시 라이브 추론 (실선, 항상 존재)
  AP(Opal) 유선 SSH 폴링 ──▶ 7-feature 계산 ──▶ min-max 스케일러 ──▶ 윈도우(12폴링) ──▶ Early Exit LSTM ──▶ 모델 예측
                                                                                                        │
· · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · · │· · · ·
Lane B ─ 라벨 계산, 학습 전용 (점선, 배포엔 없음)                                                            │
  victim 프로브(300kbps UDP) + ping ──▶ 표준 앵커 매핑(Y.1541·G.114·Cisco QoS·Aruba) ──▶ max(...) ──▶ 지속성 게이트(k=2,m=2) ──▶ 정답 label
                                                                                                        │           │
                                                                                                        ▼           ▼
                                                          학습 단계 — 예측 vs 정답 loss → 역전파로 Lane A의 LSTM 가중치 갱신
```

라벨 산정에 쓴 지표(프로브 jitter·loss, ping latency)는 모델 입력 7개 어디에도 없다 — **두 레인이 공유하는 컬럼이 없다는 것 자체가 순환논리 차단의 증거**다.
