...
- [v] BranchyNet 논문 정독 완료
- [v] ACM Survey 논문 정독 완료
- [v] Early Exit LSTM 구조도 손으로 그려보기 완료
- [v] `models/early_exit_lstm.py` 모델 클래스 구현 완료
- [v] Entropy 계산 모듈 구현 완료
- [v] Multi-exit loss 구현 완료
- [v] Inference 모드 (조기 종료) 구현 완료
