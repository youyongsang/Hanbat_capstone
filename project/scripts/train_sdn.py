"""Train SDN-style Early Exit LSTM with SDN weighted multi-exit loss."""
...
from models.sdn_lstm import SDNLSTM, sdn_multi_exit_loss  # noqa: E402
...
def run_epoch(
    ...
    for x_batch, y_batch in dataloader:
        ...
        loss = sdn_multi_exit_loss(exit_logits, y_batch)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train SDN LSTM.")
...
def main() -> None:
    ...
    checkpoint_path = args.checkpoint_dir / "sdn_lstm_best.pth"
    best_val_acc = -1.0
    ...
    print(f"SDN Model saved: {display_path(checkpoint_path)}")
