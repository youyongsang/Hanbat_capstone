...
def main():
    ...
    train_loader = get_dataloader("data/real/train.csv", batch_size=batch_size, shuffle=True)
    val_loader = get_dataloader("data/real/val.csv", batch_size=batch_size, shuffle=False)
