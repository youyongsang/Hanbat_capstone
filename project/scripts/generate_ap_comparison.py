    ...
    rows = [
        {
            ...
            "interpretation": "accuracy upper-bound baseline; no early stopping; real Pi INT8 latency 0.739ms (2026-08-30, power=0.0)",
        },
        {
