...
최종 업데이트: 2026-08-24 (새벽, yongsang DESKTOP-29GLQJF 세션 — Claude Code와 함께 진행)
...
- [ ] **최우선(다음 세션)**: AP 몇 시간 이상 휴식 후, (a) 다른 폰(221)으로 교체해서 "폰 송신 = 즉시 크래시"가 재현되는지 확인 — 재현 안 되면 191 폰 특정 문제, 재현되면 AP 자체의 폰-호환성 문제로 원인 좁히기, (b) 폰 송신을 10~20Mbps 저전력으로 재시도, (c) 채널폭 제한(2.4GHz 또는 5GHz 20MHz)과 병행 — 목표는 안전하게 label 3을 만드는 조합 찾기
