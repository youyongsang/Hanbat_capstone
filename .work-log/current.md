...
**남은 것**: (세션 1 라벨 재계산·기존 모델 평가 완료) 6-feature 모델 체크포인트 재학습 후 7 vs 6-feature 독립 세션 비교 / 2.4GHz 세션 추가(다른 날 2~3회, 목표 독립 구간 20~30) / 노트북 자동 연결 설정 결정 / Pi 다운 원인 확인 / 5GHz "AP 크래시" 재검토.
