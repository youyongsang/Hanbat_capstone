...
**남은 것**: 세션 1 데이터 라벨 재계산(게이트)·기존 2.4GHz 모델(7-feature·6-feature)로 평가(세션별·프로파일별·심각 유형별, 독립 구간 부트스트랩) / 2.4GHz 세션 추가(다른 날 2~3회, 목표 독립 구간 20~30) / 노트북 자동 연결 설정 결정 / Pi 다운 원인 확인 / 5GHz "AP 크래시" 재검토.
