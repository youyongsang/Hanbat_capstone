...
정확한 최신 수치는 `.work-log/current.md`를 확인한다(세션마다 갱신됨). 2026-08-25 새벽 세션 기준 `metrics_v2.csv` 3767행(data rows 3766), 최근 평가는 전체 정확도 89.6%(지금까지 최고), Label 3 recall 33.3%(test 9개 중 3개) — test label 3이 9개로 늘어 두 자릿수 중반 목표에 가까워지는 중.
