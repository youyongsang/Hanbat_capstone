...
정확한 최신 수치는 `.work-log/current.md`를 확인한다(세션마다 갱신됨). 2026-08-24 저녁 세션 기준 `metrics_v2.csv` 2288행(data rows 2287), 최근 평가는 전체 정확도 82.5%(fixed)/83.1%(dynamic), Label 3 recall 57.1%(test 7개 중 4개) — 표본이 7개 수준이라 여전히 세션마다 흔들릴 수 있음.
